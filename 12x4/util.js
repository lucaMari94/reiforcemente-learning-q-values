...
function setStateDeathAndWin(death_state, small_goals, big_goals){
	const p_grid = [30, 90, 150, 210, 270, 330, 390, 450, 510, 570, 630, 690];
	var obj = {};
	...
	for(i=0; i < death_state; i++){
		var x = x + 60; //p_grid[Math.floor(Math.random() * p_grid.length)];
		var y = 210;
